...
$\operatorname{Span} \begin{Bmatrix}\vec{v_1}, \dots, \vec{v_k}\end{Bmatrix}= \operatorname{Span} \begin{Bmatrix}\vec{v_1}, \dots,\vec{v_{i-1}}, \vec{v_{i+1}}, \dots, \vec{v_k} \rifht\}$

## Linearly Dependent & Independent

a set of vectors $\begin{Bmatrix}\vec{v_1},\dots ,\vec{v_k}\rifht\} \in \mathbb{R}^n$ is said to
