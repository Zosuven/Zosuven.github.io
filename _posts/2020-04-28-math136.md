...
let $\beta = \left\{\vec{v_1}, \dots,\vec{v_k}\right\}$ be a set of vector in $\mathbb{R}^n$.
we define the **span** of $\beta$ by

$span \beta =\left\{c_1\vec{v_1}+c_2\vec{c_2}+\dots+c_k\vec{v_k} &#124; c_1, \dots, c_k \in \mathbb{R}\right\}$
...
$\operatorname{Span} \left\{\vec{v_1}, \dots, \vec{v_k}\right\}= \operatorname{Span} \left\{\vec{v_1}, \dots,\vec{v_{i-1}}, \vec{v_{i+1}}, \dots, \vec{v_k} \rifht\}$

## Linearly Dependent & Independent

a set of vectors $\left\{\vec{v_1},\dots ,\vec{v_k}\rifht\} \in \mathbb{R}^n$ is said to
...
a set of vectors $\left\{\vec{v_1}, \dots, \vec{v_k}\right\} \in \mathbb{R}^n$ is linearly dependent if and only if
$\vec{v_i}\in \operatorname{Span} \left\{\vec{v_1}, \dots, \vec{v_{i-1}}, \vec{v_{i+1}}, \dots, \vec{v_k}\right\}$ for some $i$, $1\le i \le k$.

### Theorem 3

if a set of vectors $\left\{\vec{v_1}, \dots, \vec{v_k}\right\}$ contains the zero vector, then it is linearly dependent
...
if $\left\{\vec{v_1}, \dots,\vec{v_k}\right\}$ is a linearly independent set of vectors in $\mathbb{R}^n$ such that $S=\operatorname{Span} \left\{\vec{v_1},\dots, \vec{v_k}\right\}$, then the set $\left\{\vec{v_1}, \dots, \vec{v_k}\right\}$ is called a **basis** for $S$.

we define a basis for the set $\left\{\vec{0}\right\}$ to be the empty set.

### standard basis

in $\mathbb{R}^n$, let $\vec{e_i}$ represents the vector whose i-th component is $1$ and all other components are $0$. the set $\left\{\vec{e_i}, \dots, \vec{e_n}\right\}$ is called the **standard basis** for $\mathbb{R}^n$

### Theorem 4 (basis for a set)

if $\beta =\left\{\vec{v_1}, \dots, \vec{v_k}\right\}$ is a basis for a subset $S$ of $\mathbb{R}^n$, then every vector $\vec{x} \in S$ can be written as a unique linear combination of the vector in $\beta$.
...
let $\vec{v_1}, \vec{v_2}, \vec{b}\in \mathbb{R}^n$ with $\left\{\vec{v_1}, \vec{v_2}\right\}$ being a linearly independent set.
...
let $\vec{v_1}, \dots, \vec{v_{n-1}}, \vec{b}\in \mathbb{R}^n$ with $\left\{\vec{v_1}, \dots, \vec{v_{n-1}}\right\}$ being linearly independent.
...
let $\vec{v_1},\dots, \vec{v_k}, \vec{b}\in \mathbb{R}^n$ with $\left\{\vec{v_1},\dots,\vec{v_k}\right\}$ linearly independent.
