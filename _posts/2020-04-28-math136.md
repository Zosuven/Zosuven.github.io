...
it is to prove that $\operatorname{Span} \beta \subset \mathbb{S}$ and $\mathbb{S}\subset\operatorname{Span}\beta$

note that if all of the vectors in $\beta$ are in $\mathbb{S}, (this step is **trivial**, and often *omitted*)

then we must have $\operatorname{Span}\beta \subset \mathbb{S}$,
