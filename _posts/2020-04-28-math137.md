...
1. $#&124；ab#&124； =#&124；a#&124；#&124；b#&124；$

2. $#&124；\frac{a}{b}#&124；=\frac{#&124；a#&124；}{#&124；b#&124；}$

3. $#&124；a#&124；=\sqrt{a^2}$ used for derivatives

4. $-#&124；a#&124；\le a\le #&124；a#&124；$

   (if $c\ge 0$ , then $#&124；a#&124；\le c$ if and only if $-c\le a\le c$ )
...
$#&124；x+y#&124； \le #&124；x#&124；+#&124；y#&124；$ 

alternative form:

$#&124；a-b#&124；\le #&124；a-c#&124；+#&124；c-b#&124；$

logical equal to:

$#&124；a#&124；-#&124；b#&124；\le #&124；a-b#&124；$  (ps: $x=b, y = a-b$)

proof:

by Properties of $#&124；x#&124；$ (4),

$-#&124；x#&124；\le x \le #&124；x#&124；$ and $-#&124；y#&124； \le y \le #&124；y#&124；$  add them together

$-#&124；x#&124；-#&124；y#&124； \le x+y \le #&124；x#&124；+#&124；y#&124；$  = >  $-(#&124；x#&124；+#&124；y#&124；)\le x+y \le #&124；x#&124；+#&124；y#&124；$ 
...
if for every $\epsilon >0$ , there exists $N\in \mathbb{N}$   such that $#&124；a_n-L#&124；< \epsilon$  whenever $n>N$,
...
let $\epsilon = \frac{#&124；L-M#&124；}{2}$ , since $\lim_{n->\infty} a_n = L$ 

by definition there exists $N\in \mathbb{N}$ , such that  $#&124；a_n -L#&124；<\epsilon$  whenever $n>N_1$ ， 

since $\lim_{n->\infty} a_n = M$,  by definition there exists $N\in \mathbb{N}$ such that $#&124；a_n -M#&124；<\epsilon$, whenever $n>N_2$

if $n>\max(N_1, N_2)$

$#&124；L-M#&124；\le #&124；a_n -L#&124；+#&124；M-a_n#&124；$ (alternative from of the triangle inequality)

​               $= #&124；a_n -L#&124；+#&124；a_n -M#&124； $
...
if for every $\epsilon >0$ , there exists $\delta >0$ , such that $#&124；f(x) - L#&124； < \epsilon$    whenever  $ 0<#&124；x-a#&124；<\delta$  
...
3. $\lim_{x->a} \frac{f(x)}{g(x)}$ is of type $\frac{0}{0}$ or $\frac{\infty}{\infty}$ ...
4. $\lim_{x->a}\frac{f'(x)}{g'(x)}=L$ where $L\in \mathbb{R}$ or $L= \pm \infty$ 

then $\lim_{x->a} \frac{f(x)}{g(x)}=L$. 
...
4. not writing $\lim_{x->a}$ appropriately
...
1. $type(\frac{0}{0})$ 
   ...
   calculate $\lim_{x->1}\frac{\ln x}{x-1}$ 

   $\overset {LHR}{=} \lim_{x->1}\frac{1/x}{1}=1$ 

2. $type(\frac{\infty}{\infty})$ 

   calculate $\lim_{x->\infty} \frac{e^x}{ x^2}$ 

   $\overset{LHR}{=} \lim_{x->\infty} \frac{e^x}{2x}$ $type(\frac{\infty}{\infty})$ 

   $\overset{LHR}{=}\lim_{x->\infty} \frac{e^x}{2}=\infty$ 

   calculate $\lim_{x->\infty} \frac{\ln x}{x^{1/3}}= \lim_{x->\infty}\frac{1/x}{\frac{1}{3}x^{-2/3}} \overset{LHR}{=} \lim_{x->\infty} \frac{3}{x^{1/3}}=0$  

3. $type(0\cdot \infty)$ 

   calculate $\lim_{x->0^+}x\ln x = \lim_{x->0^+} \frac{\ln x}{1/x}$ ($type(\frac{-\infty}{\infty})$) $\overset{LHR}{=} \lim_{x->0^+} \frac{1/x}{-x^{-2}} = \lim_{x->0^+}(-x)=0$ 

   calculate $\lim_{x->-\infty}x^2 e^x = \lim_{x->-\infty}\frac{x^2} {e^{-x}}$ ($type(\frac{\infty}{\infty})$) $\overset{LHR}{=}\lim_{x->-\infty}\frac{2x}{-e^{-x}} \overset{LHR}{=}\lim_{x->-\infty} \frac{2}{e^{-x}}=0$ 

4. $type(\infty-\infty)$ (use some strategy to convert to $\frac{0}{0}$ or $\frac{\infty}{\infty}$ )

   calculate $\lim_{x->\frac{\pi}{2}^-} (\sec x-\tan x)= \lim_{x->\frac{\pi}{2}^-}(\frac{1}{\cos x}-\frac{\sin x}{\cos x})= \lim_{x->\frac{\pi}{2}^-}(\frac{1-\sin x}{\cos x})$ ($type(\frac{0}{0})$) $\overset{LHR}{=} \lim_{x->\frac{\pi}{2}^-}(\frac{-\cos x}{-\sin x})=\frac{0}{1}=0$ 

5. $type(0^0)$ 

   calculate $\lim_{x->0^+} x^x$

   $= \lim_{x->0^+ }(e^{\ln x})^x = \lim_{x->0^+ }e^{x\ln x} = e^{\lim_{x->0^+ }x\ln x}$ ---(1)

   consider the exponent:

   ​	$\lim_{x->0^+ } x\ln x=0$ $ type(0\cdot (-\infty))$ by example above , back into equation (1): $\lim_{x->0^+ }x^x =e^0=1$ 

6. $type(1^{\infty})$ 

   calculate $\lim_{x->\infty}(1+\frac{a}{x})^{bx} = (b>0) \lim_{x->\infty} (e^{\ln (1+\frac{a}{x})})^{bx}= e^{\lim_{x->\infty}bx\ln (1+\frac{a}{x})}$ ---(2)

   look at exponent:

   ​	$\lim_{x->\infty} bx \ln (1+\frac{a}{x})= b\cdot \lim_{x->\infty}\frac{\ln (1+\frac{a}{x})}{x^{-1}}$ ($type(\frac{0}{0})$) $\overset{LHR}{=} b\cdot \lim_{x->\infty} \frac{\frac{1}{1+\frac{a}{x}}\cdot (\frac{-a}{x^2 })}{-x^{-2}}=ab$ 

   ​	by equation (2), we have $\lim_{x->\infty}(1+\frac{a}{x})^{bx} =e^{ab}$  
...
If for every $\epsilon >0$ , there exists $\delta >0$ such that $#&124；f(x)-L#&124；<\epsilon$   whenever $0< x-a<\delta$ ($a<x<a+\delta$)($x$ 比$a$ 大)

​	then $\lim_{x->a^{+}}f(x)=L$ 

If for every $\epsilon >0$ , there exists $\delta >0$ such that $#&124；f(x)-L#&124；<\epsilon$   whenever $0< a-x<\delta$ ($a<x<a+\delta$)($x$ 比$a$ 小)
...
​	$f(x)\le g(x) \le f(x)$ and $\lim_{x->a}f(x)=L=\lim_{x->a}h(x)$ 
...
$\lim_{x->0}\frac{\sin x}{x}=1$ , $\lim_{x->0}\frac{x}{\sin x}=1$, $\lim_{x->0}\frac{1-\cos x}{x}=0$ 
...
​	if $0<#&124；x-a#&124；<\delta$ then  $f(x)>M$, 

​		then we write $\lim_{x->a}f(x)=\infty$ 
...
if $x>N$, then $#&124；f(x)-L#&124；<\epsilon$ , then $\lim_{x->\infty} f(x)=L$ 
...
if $x>N$, then $f(x)>M$, then $\lim_{x->\infty}f(x)=\infty$ 
...
if $\lim_{x->\infty}f(x)=L$ or $\lim_{x->-\infty}f(x)=L$, then we say that 

​	the line $y=L$ is a horizontal asymptote

if $\lim_{x->a^{+}}f(x)=\pm \infty$ or $\lim_{x->a^{-}}f(x)=\pm \infty$ , then 
...
$\lim_{x->\infty}\frac{\ln x}{x^{p}}=0$ for all $p>0$ 

proof:

observe $\ln x=\frac{p}{p}\ln x= \frac{1}{p}\ln x^{p}$ , so $\lim_{x->\infty}\frac{\ln x}{x^p}=\lim_{x->\infty}\frac{1}{p}\frac{\ln x^{p}} {x^{p}}=\frac{1}{p}(0)=0$ 

**a useful trick**:

ex: Evaluate $\lim_{x->2}\frac{\sin(x+2)}{x+2}$ 

​	sol: let $h=x+2 $ 

​			as $x->-2$, then $h->0$    $\lim_{x->-2}\frac{\sin(x+2)}{x+2}= \lim_{h->0}\frac{\sin h}{h}=1$



### Theorem ($x->a$ to $h->0$)

if $\lim_{x->a}f(x)$ exists, then  $\lim_{x->a}f(x)= \lim_{h->0}f(a+h)$ 
...
for every $\epsilon >0$ , there exists $\delta >0$ such that     if $#&124；x-a#&124；<\delta$ , then $#&124；f(x)-f(a)#&124；<\epsilon$  
...
if $ \lim_{n->\infty}x_n=a$ ($x_n$ has the limit $a$ ), then $\lim_{n->\infty}f(x_n)=f(a)$ 

**Ⅳ(h->0)**

if $\lim_{h->0}f(a+h)=f(a)$, then $f$ is continuous at $x=a$ 
...
let $f, g$ be functions and let $h=gof$, which is actually $g(f(x))$
...
since $\lim_{x->a}f(x)=f(a)$, so for any $\{x_n\}$ such that $\lim_{n->\infty}x_n=a$, we have $\lim_{n->\infty}f(x_n)=f(a)$ 

since $\lim_{y->f(a)} g(y)=g(f(a))$ and $\{f(x_n)\}$ has limit $f(a)$, we get $\lim_{n->\infty}g(f(x_n))=g(f(a))$ 

so, by the formal definition of continuity Ⅲ

$\lim_{x->a}g(f(x))=g(f(a))$ 
...
1. if $\lim_{x->a}f(x)$ does not exists 

   ​	a. if $\lim_{x->a^{+}}f(x)$ or $\lim_{x->a^{-}}f(x)$ DNE:  **essential discontinuity**

   ​	b. if $\lim_{x->a^{+}}f(x)$ and $\lim_{x->a^{-}}f(x)$ exist, but are not equal: **jump discontinuity**

2. if $\lim_{x->a}f(x)$ exists but dose not equal $f(a)$ or $f(a)$ does not exist, this is called **removable discontinuity** 
...
​	there exists a root $c$ of $f$ satisfying $#&124；c-d#&124；<\epsilon$ 
...
​	$f'(a)= \lim_{h->0}\frac{f(a+h)-f(a)}{h}$ or $f'(a)=\lim_{x->a}\frac{f(x)-f(a)}{x-a}$ 
...
​					 since $f'(a)=\lim_{x->a}\frac{f(x)-f(a)}{x-a}$ 

​					$=\lim_{x->a}\frac{f(x)-f(a)(x-a)}{x-a}+f(a) = f'(a)(0)+f(a)=f(a)$ 
...
in this case, we define the derivative function of $f$ on $I$ by $f'(x)= \lim_{h->0}\frac{f(x+h)-f(x)}{h}$ for all $x\in I$.
...
​	$(fg)'=\lim_{h->0}\frac{(fg)(x+h)-(fg)(x)}{h}=\lim_{h->0}\frac{f(x+h)g(x+h)-f(x)g(x)}{h}$ 
...
​	$(\frac{f}{g})'=\lim_{h->0}(\frac{f(x+h)}{g(x+h)}-\frac{f(x)}{g(x)})\frac{1}{h}=\lim_{h->0}\frac{g(x)f(x+h)-g(x+h)f(x)}{g(x+h)g(x)h}$ 

​			$=\lim_{h->0}\frac{g(x)f(x+h)-g(x)f(x)+g(x)f(x)-g(x+h)f(x)}{g(x+h)g(x)h}$ 

​			$=\lim_{h->0}\frac{1}{g(x+h)g(x)}[g(x)(\frac{f(x+h)-f(x)}{h})-f(x)(\frac{g(x+h)-g(x)}{h})]$
...
2. how curvy the function is
   ...
   how curvy a function depends on $f^n$ 

3. if $f$ is continuous on $[x,a]$ 

note: 

1. if the graph is concave up ($f''>0$), then $L_{a}^(f) (x)$ is an underestimate
2. if the graph is concave down($f''<0$), then ... is an overestimate
...
then $\lim_{x->a}\frac{#&124；f(x)-L_{a}^f(x)#&124；}{#&124；x-a#&124；}=0$   (the error goes to $0$ faster than the distance from $x$ to $a$ )

in which error $=#&124；f(x)-L_{a}^f (x)#&124；$ 
...
if $#&124；f''(x)#&124；\le M$ for all $x\in I$ , then

$#&124；f(x)-L_{a}^f(x)#&124； \le \frac{M}{2}(x-a)^2$ for all $x \in I$ 
...
if $f''(x)>0$ for all $x$ in an interval $I$, then the graph of $f(x)$ is **concave up**

if $f''(x)<0$ for all $x\in I$, then the graph of $f(x)$ is **concave down** on $I$. 

Note:

if the graph of $f$ is concave up on $I$, does that imply $f''(x)>0$ for all $x\in I$?

​	No, counterexample $f(x)=x^4, f'(x)=4x^3, f''(x)=12x^2$  when $f''(x)=0$ 
...
if $f''(x)$ is **continuous** at $x=c$ and $x=c$ is an inflection point of $f$, then $f''(c)=0$ 
...
1. if $f''(c)>0$, then $c$ is a local Min of $f$.
2. if $f''(c)<0$, then $c$ is a local Max of $f$.
...
3. Horizontal or vertical asymptotes
   ...
   $\lim_{x->\pm \infty} f(x)$  and $\lim_{x->a^+ }f(x)=\pm \infty$ 
...
$\lim_{x->a}\frac{f(x)-L_a^f(x)}{x-a}= 0$ 

proof: $\overset{LHR}{=} \lim_{x->a}\frac{f'(x)-f'(a)}{1}$ (form $\frac{0}{0}$) $=0$ 

the **Error** in the **linear approximation theorem**:

​	if $#&124；f''(x)#&124；\le M$, $#&124；f(x)-L_a^f (x)#&124；\le \frac{M}{2} (x-a)^2$ 
...
so, the second degree approximation is $T_{2,a} (x)= f(a)+f'(a)(x-a)+\frac{1}{2}f''(a)(x-a)^2$ 
...
​	$T_{n,a}(x)=f(a)+f'(a)(x-a)+\frac{f''(a)}{2!}(x-a)^2 +\frac{f^{(3)} (a)}{3!}(x-a)^3+\cdots +\frac{f^{(n)} (a)}{n!}(x-a)^n = \sum_{k=0}^n \frac{f^{(k)} (a)}{k!}(x-a)^k$ 
...
​	$T_{2,0}(x)=f(0)+f'(a)(x-a)+\frac{f''(0)}{2!}(x-0)^2= 1+\frac{1}{2}x-\frac{1}{8}x^2$ 
...
​	observe $#&124；f^{(3)} (c)#&124；= #&124；\frac{3}{8}\cdot \frac{1}{(1+c)^{\frac{5}{2}}}#&124；< \frac{3}{8}$  $#&124；error#&124；= #&124；R_{2,0}(x)#&124；= #&124；\frac{f^{(3)} (c)}{3!}x^3#&124；< \frac{3}{8}\cdot \frac{1}{6}#&124；x#&124；^3< \frac{1}{16}$ 
...
a. $f(x)= x^{-1}, f(1)=1, f'(x)=-x^{-2}, f'(1)= -1, f''(x)= 2x^{-3}, f''(1)= 2$ 

​	$T_{2,1}(x)= f(1)+f'(1)(x-1) +\frac{f''(1)}{2!}(x-1)^2= 1-(x-1)+(x+1)^2$ 

b. $\frac{1}{1.1}= f(1.1) \approx T_{2,1} (1.1)=0.91$ 

c. $f^{(3)} (x)= -6x^{-4}<1$ 

​	$#&124；error#&124；= #&124；R_{2,1}(x)#&124；= #&124；\frac{f^{(3)} (c)}{3!}(x-1)^3#&124； <\frac{6}{6}(0.1)^3=0.001$
...
Example:  Evaluate $\lim_{x->0}\frac{e^x -1-x}{x^2}$ 

sol: let $f(x)=e^x$ . On the interval $(-1, 1)$ , we get by **Taylor's Theorem** that there exists $c\in (-1, 1)$ such that

​		$e^x = 1+x+\frac{x^2}{2!} +\frac{f^{(3)} (c)x^3}{3!}$  so, $\lim_{x->0} \frac{e^x -1-x}{x^2}= \lim_{x->0} \frac{\frac{x^2 }{2!}+\frac{f^{(3)} (c)}{3!}x^3 }{x^2 }= \lim_{x->0}(\frac{1}{2}+\frac{f^{(3)} (c)}{3!})= \frac{1}{2}$ 



Example: Evaluate $\lim_{x->0} \frac{{e^x}^4 -\cos x^2 }{x^4 }$ 
...
then   $= \lim_{x->0} \frac{{e^x}^4 -\cos x^2} {x^4} = \lim_{x->0} \frac{x^4 +\frac{f^{(8)} (c)x^8 }{8!}-\frac{x^4 }{2!}+\frac{g^{(8)} (c)x^8 }{8!}}{x^4}= \lim_{x->0} 1+f^{(8)} (c)x^4 +\frac{1}{2}-g^{(8)} (c)x^4 = \frac{3}{2}$ 
